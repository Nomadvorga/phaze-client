...
public final class TabHud extends RectHudModule {
    ...
    public final BooleanSetting nameShadow = new BooleanSetting("Name Shadow", "Add shadow for names").setValue(true);
    public final BooleanSetting moveSelfTop = new BooleanSetting("Move Self Top", "Move self line to top").setValue(false);
    ...
    private TabHud() {
        ...
        nameShadow.setFullWidth(true);
        moveSelfTop.setFullWidth(true);
        displayPingAsNumber.setFullWidth(true);
        pingNumberShadow.setFullWidth(true);
        dynamicPingColor.setFullWidth(true);
        setup(colorSection2, highlightOwn, nameShadow, moveSelfTop, displayPingAsNumber, pingNumberShadow, dynamicPingColor);
    }
