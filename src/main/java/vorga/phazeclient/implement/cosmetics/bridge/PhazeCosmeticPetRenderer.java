...
public final class PhazeCosmeticPetRenderer {
    ...
    private static void render(WorldRenderContext ctx,
        ...
        if (!CosmeticsRenderer.shouldRenderFor(player)) return;
        CosmeticEntry entry = CosmeticsSyncService.getInstance()
                .phazeEntryFor(player.getUuid(), CosmeticCategory.PET);
        ...
        PhazeGeoRenderer.renderPet(entry, matrices, ctx.consumers(), 0xF000F0,
    ...
    private PhazeCosmeticPetRenderer() { }
}
