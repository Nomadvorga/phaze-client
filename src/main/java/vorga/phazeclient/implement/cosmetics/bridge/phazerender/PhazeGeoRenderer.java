...
import vorga.phazeclient.implement.cosmetics.bridge.phazerender.geo.*;
...
public final class PhazeGeoRenderer {
    ...
    public static boolean render(CosmeticEntry entry,
                                 ...
                                 boolean moving,
                                 float timeSeconds) {
        PhazeSourceModel source = PhazeSourceModelLoader.get(entry);
    ...
    private static void applyAnimation(PhazeSourceModel source, AnimationData animation, float timeSeconds) {
