...
import me.zyouime.hitcolor.mixin.accessor.INativeImageMixin;
...
class GlyphMap {
   ...
   public static void registerBufferedImageTexture(class_2960 i, BufferedImage bi) {
      try {
         ...
         long ptr = ((INativeImageMixin)image).getPointer();
         ...
         if (RenderSystem.isOnRenderThread()) {
            ...
            RenderSystem.recordRenderCall(() -> class_310.method_1551().method_1531().method_4616(i, tex));
         }
      } catch (Throwable e) {
         e.printStackTrace();
      }
